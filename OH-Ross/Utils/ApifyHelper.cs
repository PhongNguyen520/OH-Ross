...
public static class ApifyHelper
{
    ...
    /// <summary>Get Actor input (async). Use when running on Apify or locally.</summary>
    ...
    /// <summary>Sets the status message displayed on the Apify Dashboard for the current run.</summary>
